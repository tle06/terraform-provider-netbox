...
func TestAccDcimDevice_basic(t *testing.T) {
	device_type_id := "7"
	device_role_id := "4"
	...
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: testAccCheckDcimDeviceDestroy,
		Steps: []resource.TestStep{
			{
				Config: testAccCheckDcimDeviceConfigBasic(device_type_id, device_role_id),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDcimDeviceExists("netbox_dcim_device.test"),
				),
			},
		},
	})
...
func testAccCheckDcimDeviceDestroy(s *terraform.State) error {
...
func testAccCheckDcimDeviceExists(n string) resource.TestCheckFunc {
